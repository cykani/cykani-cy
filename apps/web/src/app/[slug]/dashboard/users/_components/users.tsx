      ...
      <CardContent className="flex flex-col gap-4 px-0">
        <div className="flex flex-wrap items-center justify-between gap-3 px-4">
          <div className="flex flex-wrap items-center gap-3">
            <Select value={roleFilter} onValueChange={(value: any) => setColumnSelectFilter("role", value)}>
            ...
            <Select value={teamFilter} onValueChange={(value: any) => setColumnSelectFilter("team", value)}>
              <SelectTrigger size="sm">
            ...
            <Select value={statusFilter} onValueChange={(value: any) => setColumnSelectFilter("status", value)}>
              <SelectTrigger size="sm">
          ...
          <Select value={workspaceFilter} onValueChange={(value: any) => setColumnSelectFilter("workspace", value)}>
            <SelectTrigger size="sm">
