...
const useCases = [
  ...
  {
    tag: "AI AGENTS",
    name: "Give your agent a browser that doesn't get caught.",
    desc: "LLM-powered agents need to click, fill, scroll, and navigate real websites. Any trace of automation gets them blocked. Cykani's CDP gateway gives your agent a fully human-looking browser session from first paint — persistent, stealthy, and ready in one line.",
    ascii: [
      "┌─ agent.ts ──────────────────┐",
      "│                             │",
      "│  agent.goto('target.com')   │",
      "│  agent.fill('#email', ...)  │",
      "│  agent.click('#submit')     │",
      "│                             │",
      "│  bot score:  0.02   ✓       │",
