...
const dayRowCommonClasses: CalendarOptions = {
  ...
  listItemEventClass: (info: any) => cn(
  ...
  listItemEventInnerClass: (info: any) => cn(
    'flex flex-row items-center justify-between',
    info.isNarrow
      ? `py-px ${xxsTextClass}`
      : 'py-0.5 text-xs',
  ),
  listItemEventTimeClass: (info: any) => cn(
    info.isNarrow ? 'px-px' : 'px-0.5',
    'order-1 whitespace-nowrap overflow-hidden shrink-1',
  ),
  listItemEventTitleClass: (info: any) => cn(
    info.isNarrow ? 'px-px' : 'px-0.5',
  ...
  rowEventClass: (info: any) => cn(
    info.isStart && (info.isNarrow ? 'ms-0.5' : 'ms-1'),
    info.isEnd && (info.isNarrow ? 'me-0.5' : 'me-1'),
  ),
  rowEventInnerClass: (info: any) => cn(info.isNarrow ? 'py-px' : 'py-0.5'),

  /* Day Row > More-Link
  ----------------------------------------------------------------------------------------------- */

  rowMoreLinkClass: (info: any) => cn(
  ...
  rowMoreLinkInnerClass: (info: any) => cn(
    info.isNarrow
      ? `p-px ${xxsTextClass}`
      : 'p-0.5 text-xs',
  ),
  ...
  return (
    <FullCalendar
      height={height}
        ...
        backgroundEventTitleClass={(info: any) => cn(
          'opacity-50 italic',
        ...
        rowEventBeforeClass={(info: any) => cn(
          info.isStartResizable && [
            info.isSelected ? rowTouchResizerClass : rowPointerResizerClass,
            '-start-1',
          ]
        )}
        rowEventAfterClass={(info: any) => cn(
          info.isEndResizable && [
            info.isSelected ? rowTouchResizerClass : rowPointerResizerClass,
            '-end-1',
          ]
        )}
        rowEventInnerClass={(info: any) => cn(
          'flex flex-row items-center',
          info.isNarrow ? xxsTextClass : 'text-xs',
        )}
        rowEventTimeClass={(info: any) => cn(
          info.isNarrow ? 'ps-0.5' : 'ps-1'
        )}
        rowEventTitleClass={(info: any) => cn(
        ...
        columnEventBeforeClass={(info: any) => cn(
          info.isStartResizable && [
            info.isSelected ? columnTouchResizerClass : columnPointerResizerClass,
            '-top-1',
          ]
        )}
        columnEventAfterClass={(info: any) => cn(
          info.isEndResizable && [
            info.isSelected ? columnTouchResizerClass : columnPointerResizerClass,
            '-bottom-1',
          ]
        )}
        columnEventInnerClass={(info: any) => cn(
          'flex',
          info.isShort
        ...
        columnEventTimeClass={(info: any) => cn(
          !info.isShort && (info.isNarrow ? 'pt-0.5' : 'pt-1')
        )}
        columnEventTitleClass={(info: any) => cn(
        ...
        columnMoreLinkInnerClass={(info: any) => cn(
          info.isNarrow
            ? `p-0.5 ${xxsTextClass}`
            : 'p-1 text-xs',
        )}
        ...
        dayHeaderContent={(info: any) => (
          (info.inPopover || !info.dayNumberText || !info.isToday) ? (
            ...
            <>
              {info.textParts.map((textPart: any, i: any) => (
                <span
                  key={i}
                  className={cn(
                    'whitespace-pre',
        ...
        dayCellClass={(info: any) => cn(
          'border',
          info.isMajor && 'border-foreground/20',
        )}
        dayCellTopClass={(info: any) => cn(
          info.isNarrow ? 'min-h-0.5' : 'min-h-1',
          'flex flex-row justify-end',
        )}
        dayCellTopInnerClass={(info: any) => cn(
          'flex flex-row items-center',
          info.isNarrow
        ...
        dayCellInnerClass={(info: any) => cn(info.inPopover && 'p-2')}
        ...
        dayLaneClass={(info: any) => cn(
          'border',
          info.isMajor && 'border-foreground/20',
          info.isDisabled && 'bg-foreground/3',
        )}
        dayLaneInnerClass={(info: any) => (
          info.isStack
            ? 'm-1'
            : info.isNarrow ? 'mx-px' : 'mx-0.5'
        )}
        slotLaneClass={(info: any) => cn(
          'border',
        ...
        listDayHeaderInnerClass={(info: any) => cn(
        ...
        inlineWeekNumberClass={(info: any) => cn(
        ...
        views={{
          ...
          dayGrid: {
            ...
            dayHeaderAlign: (info: any) => info.inPopover ? 'start' : info.isNarrow ? 'center' : 'end',
          ...
          multiMonth: {
            ...
            tableHeaderClass: (info: any) => cn(info.multiMonthColumns === 1 && 'bg-background'),
            dayHeaderAlign: (info: any) => info.inPopover ? 'start' : info.isNarrow ? 'center' : 'end',
            dayHeaderDividerClass: (info: any) => cn(info.multiMonthColumns === 1 && 'border-b'),
            dayCellBottomClass: getShortDayCellBottomClass,
            tableBodyClass: (info: any) => cn(info.multiMonthColumns > 1 && 'border rounded-sm overflow-hidden'),
            ...userViews?.multiMonth,
          },
          timeGrid: {
            ...dayRowCommonClasses,
            tableHeaderClass: 'bg-background',
            dayHeaderAlign: (info: any) => info.inPopover ? 'start' : 'center',
            dayHeaderDividerClass: (info: any) => cn(
              'border-b',
            ...
            weekNumberHeaderInnerClass: (info: any) => cn(
            ...
            allDayHeaderInnerClass: (info: any) => cn(
            ...
            slotHeaderInnerClass: (info: any) => cn(
              'relative m-2',
              info.isNarrow
