...
interface LayoutControlsProps {
  ...
  readonly setContentLayout: (layout: ContentLayout) => void;
  readonly navbarStyle: NavbarStyle;
  readonly setNavbarStyle: (style: NavbarStyle) => void;
  readonly sidebarVariant: SidebarVariant;
  readonly setSidebarVariant: (variant: SidebarVariant) => void;
  readonly sidebarCollapsible: SidebarCollapsible;
  readonly setSidebarCollapsible: (collapsible: SidebarCollapsible) => void;
  readonly font: FontKey;
  readonly setFont: (font: FontKey) => void;
