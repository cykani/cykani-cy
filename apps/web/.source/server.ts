...
import * as __fd_glob_6 from "../content/docs/guides/stealth-mode.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_4, }, {"index.mdx": __fd_glob_5, "guides/stealth-mode.mdx": __fd_glob_6, "getting-started/installation.mdx": __fd_glob_7, "getting-started/quickstart.mdx": __fd_glob_8, "sdk/autopilot.mdx": __fd_glob_9, "sdk/cdp-connection.mdx": __fd_glob_10, "sdk/humor-mode.mdx": __fd_glob_11, "sdk/overview.mdx": __fd_glob_12, "sdk/presets.mdx": __fd_glob_13, });